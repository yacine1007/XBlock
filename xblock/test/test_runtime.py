...
class TestNamespace(Namespace):
    ...
    n_course_info = String(scope=Scope.course_info, default='ncs')
...
with patch('xblock.core.Namespace.load_classes', return_value=[('test', TestNamespace)]):
    class TestModel(object):
        ...
        course_info = String(scope=Scope.course_info, default='cs')
...
def test_db_model_keys():
    ...
    assert_equals('new course_info', key_store.db[KeyValueStore.Key(Scope.course_info, None, 'u0', 'course_info')])
    ...
    assert_equals('new n_course_info', key_store.db[KeyValueStore.Key(Scope.course_info, None, 'u0', 'n_course_info')])
